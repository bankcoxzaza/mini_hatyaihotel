...
//	printf(" 	   PLEASE PAY NOW !!!  \n\n");
	...
	printf("\n    Payment information \n");
	printf("    Booking number  : 2018%d\n",randomNumber);
	printf("    PIN Code        : %d\n",randomPin);
	

	
	//file white
	fprintf(fptrp,"%s,%s,%s,%d,Adults x %d,Children x %d,%s,%s,%.2f,2018%d,%d\n",name,hotel1,type_room,c_room,c_adult,c_child,email,tel,total,randomNumber,randomPin);
	fclose(fptrp);
...
void Showdetail(){
		...
		printf("   > Sauna. \n");
		printf("   > Black out curtains. \n");
		printf("   > Daily house keeping. \n\n");
		
		printf("  - Some helpful facts \n");
		printf("   Check in\n");
		printf("   > Check in from  : 14.00 \n");
		printf("   > Check in until : 18.00 \n");
		printf("   Check out\n");
		printf("   > Check out from  : 09.00 \n");
		printf("   > Check out until : 12.00 \n\n");
}
